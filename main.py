...
#
# cursor.execute('''
#     INSERT INTO customer (id, name, family, phone) VALUES (NULL, ?, ?, ?)
# ''', (name, family, phone))
#
#
# conn.commit()
...
# #           part 3
# # updating value of row in table
#
# id_update = int(input("Please enter you id for update: "))
# name_update = input("Please enter you name for update: ")
# family_update = input("Please enter you family for update: ")
# phone_update = input("Please enter you phone number for update: ")
#
# cursor.execute('''
#     UPDATE customer SET name=?, family=?, phone=? WHERE id=?
# ''', (name_update, family_update, phone_update, id_update))
#
#
# conn.commit()
...
# # delete row in table
#
# id_delete = int(input("Please enter you id for delete: "))
#
# cursor.execute('''
#     DELETE FROM customer WHERE id=?
# ''', (id_delete,))
